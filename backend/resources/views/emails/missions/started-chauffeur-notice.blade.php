...
@include('emails._layout', [
  ...
  'slot' => new \Illuminate\Support\HtmlString('
    ...
    <p style="margin:0 0 12px 0;">Vous avez bien démarré la mission suivante. Une copie d’information a également été envoyée à l’équipe Smart Fleet.</p>
    <div style="background:#f8fafc;border:1px solid #e5e7eb;border-radius:12px;padding:12px 12px;margin:10px 0 14px;">
      ...
      <div style="margin-top:6px;color:#475569;font-size:13px;">Statut : <strong>en cours</strong></div>
    </div>
  ')
])
